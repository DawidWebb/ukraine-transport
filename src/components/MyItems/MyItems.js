...
import {Button, TransportItem} from "../../components";
import { ADD_BTN_LG, VECHICLE_ITEMS_LG, NEEDS_ITEMS_LG } from "../../assets/languages";
    ...
    kindOfItem === "vechicles"
      ...
      const operationButtons = "vehicles"
          ...
          ? (
            ...
            <Button
            type="button"
            name={language[0] === "PL" ? VECHICLE_ITEMS_LG[2].pl : VECHICLE_ITEMS_LG[2].ua}
            onClick={handleAddVechicle}
          />
          <Button
            type="button"
            name={language[0] === "PL" ? VECHICLE_ITEMS_LG[3].pl : VECHICLE_ITEMS_LG[3].ua}
